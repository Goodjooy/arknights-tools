return {
  ...
  profile = {
    records = {
      ...
      archive2 = "虽然没有到感染者的地步，但作为一个公认的事实，萨卡兹人也在现代社会中受到排挤，排挤程度因地而异。<br>这涉及到一些历史遗留问题，不便在此处展开讨论，仅以结论来说，大部分萨卡兹人都多少与主流有些脱轨，愤世嫉俗、独善其身、我行我素等等这些词，往往是他们的代名词。<br>从这个意义上，陨星小姐是萨卡兹中人的异类，她虽然也因为主流社会的排挤而戴上了冰冷的面具，但面具下那颗尚未冷却的心，是罗德岛中的每个干员都有目共睹的。",
    ...
    oripathy = {
      infected = "Yes",
      diagnosis = "造影检测结果显示，该干员体内脏器轮廓模糊，可见异常阴影，循环系统内源石颗粒检测异常，有矿石病感染迹象，现阶段可确认为是矿石病感染者。<br><br>【体细胞与源石融合率】7%<br>体表暂未出现明显的矿石病病征。<br><br>【血液源石结晶密度】0.33u/L<br>感染步入中期，目前无扩散倾向。",
    }
  },
  quotes = {
