return {
      ...
      levels = {
        {
          ...
          level = 1,
          potential = 0,
          description = "When deployed, slightly increase the SP recovery speed of all allies (+0.15 SP/sec)",
        },
        {
          elite = 2,
          level = 1,
          potential = 0,
          description = "When deployed, largely increase the SP recovery speed of all allies (+0.3 SP/sec)",
        },
      }
    },
  },
  ...
  profile = {
    records = {
      ...
      archive1 = "......<br>您好。请问，需要何种帮助？<br>......<br>针对您的提问，白面鸮的回答是：正确。目前与您正在进行交流的对话界面，正是干员白面鸮本人。<br>作为罗德岛部分公开数据的维护协助干员，白面鸮拥有完全的查阅权限、自由评论权限，以及部分经限制的修改权限。<br>于此同时，数据记录专员，正处于对话记录工作流程中，关于您做出的，所有定义明确的搜索行为，将会被完全记录。<br>......<br>收到，信息已明确接收。<br>干员白面鸮，目前于罗德岛的定位为医疗干员（资深），与赫默医生相同，均为莱茵生命某项目部门前成员。<br>目前，将现代化医疗技术与相关源石技艺研究，引入、并致力使之成为罗德岛的主导性医疗项目，是我们长期以来的选择与目的。<br>同时，作为数项矿石病治疗方案的编撰与提出，亦由赫默医生主推，在这其中，白面鸮担任赫默医生的助手。在数据的记录、提取与分析工作上，白面鸮的位置将较为关键。<br>此外，对矿石病患者，干员伊芙利特，其日常监护工作，白面鸮亦从中进行一定的协助。<br>......",
      archive2 = "......<br>信息交流界面，启动。干员白面鸮，向您问好。<br>......<br>查阅有关干员白面鸮的病情信息？<br>了解，请您稍候。<br>基于您所调查的关键字，以下资料为精确检索结果：<br>白面鸮，确诊感染者。<br>病症：嗜睡。<br>临床表现：在无征兆状况下发<br>...<br>......<br>............<br>在无征兆状况下发生异常入睡现象。<br>......是的，在醒来后，重新调阅过此次对话记录，可以了解到入睡前的我所进行的话题。<br>对应这种病症，赫默医生为我开出的治疗方案，现已做为日用进程的一部分。<br>那么，回到上一话题。<br>矿石病对白面鸮带来的影响，在于对其种族特性产生的效应深化，劫持睡眠信息指令，严重干扰生体基础神经信号传递。<br>无法预判干扰会导致其日常作业效率的大幅度下降，这是矿石病对白面鸮造成的最大影响。<br>但另一方面，矿石病具备有一定意义。是的，我们不应持完全主观的态度去批判一项客观存在的事物。<br>矿石病带给白面鸮的，是重新理解眼前一切的，全新的视角。<br>重新看待自己，看待他人，以及看待这片大地，也许......还有头顶的天空。<br>每一天我都在思考着，当源石微粒随同血液流淌时，我该如何解析，计算它们的信息。<br>我该如何在它消耗我的有机资源同时，设法换取一些积极而更有意义的东西。<br>对于白面鸮来说，这将是今后人生中最值得思考的问题。<br>......",
