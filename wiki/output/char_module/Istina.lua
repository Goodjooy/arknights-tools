  ...
  skills = {
    {
      ...
      description = {
        ...
        "Reduce attack interval",
        "Reduce attack interval",
        "Highly reduce attack interval",
        "Highly reduce attack interval",
        "Highly reduce attack interval",
        "Greatly reduce attack interval",
        "Greatly reduce attack interval",
        "Greatly reduce attack interval",
        "Massively reduce attack interval",
      },
    ...
    },
    {
      ...
      passive = false,
      description = {
        "Attack power +<span style='color:#0098DC;'>20%</span>, Increase attack range, Attack 1 additional target",
        "Attack power +<span style='color:#0098DC;'>20%</span>, Increase attack range, Attack 1 additional target",
        "Attack power +<span style='color:#0098DC;'>20%</span>, Increase attack range, Attack 1 additional target",
        "Attack power +<span style='color:#0098DC;'>25%</span>, Increase attack range, Attack 2 additional targets",
        "Attack power +<span style='color:#0098DC;'>25%</span>, Increase attack range, Attack 2 additional targets",
        "Attack power +<span style='color:#0098DC;'>25%</span>, Increase attack range, Attack 2 additional targets",
        "Attack power +<span style='color:#0098DC;'>30%</span>, Increase attack range, Attack 2 additional targets",
        "Attack power +<span style='color:#0098DC;'>45%</span>, Increase attack range, Attack 2 additional targets",
        "Attack power +<span style='color:#0098DC;'>60%</span>, Increase attack range, Attack 2 additional targets",
        "Attack power +<span style='color:#0098DC;'>75%</span>, Increase attack range, Attack 2 additional targets",
      },
  ...
  infrastructure_skills = {
    {
      ...
      facility = "Training",
      unlockIcon = "elite0",
      description = "When stationed at the Training Station, increase the skill training speed of Supporter operatives by +30%"
    },
    {
      name = "Staff",
      badge = "reception",
