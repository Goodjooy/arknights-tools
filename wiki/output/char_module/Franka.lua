return {
  ...
  profile = {
    ...
    oripathy = {
      infected = "Yes",
      diagnosis = "造影检测结果显示，该干员体内脏器轮廓模糊，可见异常阴影，循环系统内源石颗粒检测异常，有矿石病感染迹象，现阶段可确认为是矿石病感染者。<br><br>【体细胞与源石融合率】9%<br>干员芙兰卡矿石病病灶位于体内。<br><br>【血液源石结晶密度】0.34u/L<br>感染步入中期，目前无扩散倾向，病症进程较为稳定。",
    }
  },
  quotes = {
