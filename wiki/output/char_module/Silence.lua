return {
  ...
  profile = {
    records = {
      ...
      archive1 = "作为科研工作者，赫默做事安静而集中，具备极强观察力，而且行事高效。善于计算的她从不会在实验数据上出错，以她严谨的科研作风，使的她带领的整个科研小组都充满了专注、忙碌，甚至有些紧张的氛围。<br>然而赫默并不像擅长自己的工作一样擅长交际和处理人际关系。在平时让自己保持独自一人，默默地观察着四周的人，维持自己的一个小世界，这才更能让赫默觉得放松。<br>不过，赫默的性格并不完全内向。她很擅长一对一的谈话，尤其是与下属交流工作时，她会表现的极富耐心，而且善于聆听，任何研究上的困难都可以毫不顾忌地对赫默诉说。可以说，维持赫默日常行动的能量，来自于集中的精神与不受打扰的自由空间。",
