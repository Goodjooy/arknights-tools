return {
  ...
  profile = {
    records = {
      ...
      archive4 = "直来直去的因陀罗最不喜欢的就是油腔滑调的人，耍什么心机，耍什么计谋，战斗不就是要面对面地正面对决吗?只有胆小鬼才会想这些东西！这样的性格让因陀罗在罗德岛和不少豪爽的干员成为了好友，大家会在练习房中切磋战斗经验，流了汗之后再去豪爽地大吃大喝一番，再说说那些智力派干员的坏话，人生诸事还有什么比这更畅快？",
      token = "",
    },
    bio = {
      gender = "Female",
