  ...
  skills = {
    {
      ...
      passive = false,
      description = "下次攻击的攻击力<span style='color:#0098DC;'>+0.5/0.8/1.1/1.4</span>，无视目标防御<span style='color:#0098DC;'>0.35/0.4/0.45/0.6</span>",
    ...
    },
    {
      ...
      passive = false,
      description = "攻击力<span style='color:#0098DC;'>+0.45/0.6/0.75/1.2</span>，伤害类型变为<span style='color:#0098DC;'>法术</span>，每次攻击恢复相当于造成伤害<span style='color:#0098DC;'>0.1/0.15/0.2/0.25</span>的生命",
