return {
  ...
  profile = {
    records = {
      ...
      archive2 = "古米活泼、善良、心思单纯，她总是会发自内心地表露出，希望大家都能获得幸福的真挚情感。<br>古米信任首领凛冬，积极为自治团内营造欢腾的气氛，竭力消除切尔诺伯格事变对乌萨斯学生们造成的困顿不安。古米坚信以行动融入罗德岛的氛围是正确的选择，并对每一位罗德岛干员均表现出友好的态度。<br>由医疗组派遣的心理辅导专员证实了一些事前猜测：古米正试图以工作与接触作为消解恐惧记忆的方式。而在数次咨询谈话中，古米没有透露有关切尔诺伯格事变期间，学生自治团成员们所经历过的事情。",
