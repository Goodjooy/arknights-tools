return {
  ...
  profile = {
    ...
    oripathy = {
      infected = "Yes",
      diagnosis = "造影检测结果显示，该干员体内脏器轮廓模糊，可见异常阴影，循环系统内源石颗粒检测异常，有矿石病感染迹象，现阶段可确认为是矿石病感染者。<br><br>体内源石融合度：7%<br>病程正在向中期过渡，但尚未对感染对象产生明显的影响。<br><br>【血液源石结晶密度】0.24u/L<br>由于为源石直接穿刺感染，崖心在被穿刺处有明显源石结晶。",
    }
  },
  quotes = {
