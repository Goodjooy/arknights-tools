return {
      ...
      levels = {
        {
          ...
          level = 1,
          potential = 0,
          description = "When deployed, all 【Vanguard】 operatives gain 10% physical evasion",
        },
        {
          elite = 1,
          level = 1,
          potential = 4,
          description = "When deployed, all 【Vanguard】 operatives gain 15% (+5%) physical evasion",
        },
        {
          elite = 2,
          level = 1,
          potential = 0,
          description = "When deployed, all 【Vanguard】 operatives gain 20% physical evasion",
        },
        {
          elite = 2,
          level = 1,
          potential = 4,
          description = "When deployed, all 【Vanguard】 operatives gain 25% (+5%) physical evasion",
        },
      }
    },
  },
  ...
  profile = {
    records = {
      ...
      archive2 = "虽然欠缺一定的作战经验，但格拉尼从不会不假思索地冲向目标。<br>大多数情况下，她会审时度势，冷静地分析战场局势，判断敌方人数与战斗力，衡量理应采取的战术，并耐心等待机会。<br>格拉尼极具优势的机动性，良好的纵深作战能力，以及展开突袭时带来的迅猛冲击力，使得她得以成为罗德岛实施机动战术时的不二人选。<br>于协同作战中，格拉尼表现出的合作能力有目共睹，而她本人亦乐于接受罗德岛赋予她的种种战术安排。<br>此外，格拉尼善长鼓舞士气，催生团队的合作精神。她总是报以积极的态度，推动不同身份、不同阵营的罗德岛成员们团结一致，这也是大多数干员们乐于与她合作的原因。在这一点上，格拉尼为罗德岛带来了积极正面的的帮助。",
