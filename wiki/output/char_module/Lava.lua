return {
  ...
  profile = {
    records = {
      ...
      archive1 = "不同于混迹于阴暗小巷中的其他流浪的孩子，炎熔出生在并不算贫穷的维多利亚普通家庭里。比起站在远处，炎熔更相信去亲身去实践去行动才能够帮助他人。从小喜欢跟贫民和流浪的孤儿打交道的炎熔，心中很清楚，这些人们的生活中到底有多少痛苦的经历。也正是因此，小小的正义的种子早早的就在炎熔的心中生根发芽。",
    ...
    oripathy = {
      infected = "Yes",
      diagnosis = "造影检测结果显示，该干员体内脏器轮廓模糊，可见异常阴影，循环系统内源石颗粒检测异常，有矿石病感染迹象，现阶段可确认为是矿石病感染者。<br><br>【体细胞与源石融合率】9.4%<br>体表暂未出现明显的矿石病病征。<br><br>【血液源石结晶密度】0.25 u/L<br>感染程度尚浅，暂时还没有带来明显身体影响。",
    }
  },
  quotes = {
    ...
    cn017 = "团队合作什么的......其他人最好别拖后腿啊。",
    cn018 = "我不太擅长这种工作，但无论如何也要做的话......",
    cn019 = "现在就出发，掩护就拜托了。",
    cn020 = "那些家伙的灵魂，注定要被我收割。",
    cn021 = "你在等什么？",
    cn022 = "快点。",
    cn023 = "来吧。",
    cn024 = "就这样。",
