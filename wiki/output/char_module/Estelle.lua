return {
  ...
  profile = {
    ...
    oripathy = {
      infected = "Yes",
      diagnosis = "造影检测结果显示，该干员体内脏器轮廓模糊，可见异常阴影，循环系统内源石颗粒检测异常，有矿石病感染迹象，现阶段可确认为是矿石病感染者。<br><br>【体细胞与源石融合率】16%<br>染病后的异化情况严重，产生了非本物种所有的长角，建议密切观察。<br><br>【血液源石结晶密度】0.31u/L<br>感染进入前期，具体影响方式还需进一步检查。<br><br>【异变观察】<br>根据目前对阿达克利斯人的观察结果显示，其双角并未普遍存在于该种族特征内。根据干员艾丝黛尔本人的自述，其成长过程中亦并未有任何生理上对此种异变的呈现过程。目前可判明为，该角质突变为矿石病导致。",
    }
  },
  quotes = {
