  ...
  skills = {
    {
      ...
      passive = false,
      description = "下次治疗额外回复目标最大生命值的<span style='color:#0098DC;'>0.11/0.15/0.19/0.25</span>\n<span style='color:#F49800;'>只当目标生命值不满一半时才会触发，可充能2/2/3/4次</span>",
    ...
    },
    {
      ...
      passive = false,
      description = "自身和攻击范围内随机一名我方单位获得以下状态：\n攻击力<span style='color:#0098DC;'>+0.3/0.45/0.6/0.9</span>，每秒损失<span style='color:#FF6237;'>0.03/0.03/0.03/0.03</span>最大生命值，持续<span style='color:#0098DC;'>15/15/15/15</span>秒",
