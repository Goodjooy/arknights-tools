return {
  ...
  profile = {
    records = {
      ...
      archive1 = "真理，切尔诺伯格事变前于切城某中学就读，在校期间多次向源石技艺相关杂志撰稿。知识领域：名家著作、推理文学、社会学期刊。<br>于多项测试中展现出优异的控制类源石技艺，获准作为实习辅助干员加入战斗，并为罗德岛提供信息与资料整理等相关服务。",
      archive2 = "真理冷静而理智，只是有些轻度内向，她时常沉浸于自己喜欢的事物：钻研更加高深的源石技艺，研读最新的社会理论，观察各种人与人之间的复杂关系，以及好看的着装搭配。<br>在与乌萨斯学生团成员的们数次接触过程中，真理表现出了难得的沟通成效和肯定态度，并针对部分咨询提供了足够清晰有效的回答。目前可以确定的是，真理对罗德岛持有积极的趋向，可做为与乌萨斯学生们沟通积极因子。",
      archive3 = "目前可知的是，“乌萨斯学生自治团”最初由真理提议组建。社团的建立帮助了乌萨斯学生们合力度过了最初的孤立与互信阶段。<br>在咨询中针对凛冬的若干提问，被真理敏锐地察觉并指出。真理认为干员凛冬虽然蛮横，但极为重视自治团的同伴，是一位称职的首领，只要在行动中加入自己提供的参考，那就更加完美了。<br>在提及干员凛冬面对博士的若干坦直言论，真理予以了否定的判断。真理认为凛冬不会成为罗德岛的不稳定因素。认为她的志向仅限于罗德岛吗，那样，未免太小瞧她了。",
      archive4 = "真理出生于乌萨斯帝国切尔诺伯格市，其父母均在本地机关任职。在学生社团浪潮此起彼伏的时间里，真理并未参与其中而选择了安静读书。不过在此期间，对嘈杂音乐和酒精饮料都不感兴趣的她，开始接触一些从莱塔尼亚和维多利亚流入的书籍。正是在这些书籍的帮助下，真理才真正懂得了，如何重新理解自己所知道的一切，以及自己即将知晓的一切。",
      token = "唯独关于切尔诺伯格事变期间的行踪，真理用谦和而简洁的理由拒绝提供进一步透露，但过程中有数次表现出较为明显的情绪变化。基于罗德岛的现行方针与守密原则，对乌萨斯学生自治团的调查目前暂时中止。<br>基于对乌萨斯学生团的背景调查，基本可以判明对方未持有任何值得质疑的背景。因此，建议对乌萨斯学生们以心理疏通为主要沟通手段。依据学生团成员的适应与自主选择，提供未来可选的合作方式。<br>备注：基于干员真理对博士办公室藏书的极度渴求，建议授予其一定的阅读权限。",
    },
    bio = {
      gender = "Female",
      experience = "没有战斗经验",
