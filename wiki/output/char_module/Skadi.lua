return {
  ...
  skills = {
    ...
    },
    {
      ...
      passive = true,
      description = {
        "部署后<span style='color:#0098DC;'>{duration}</span>秒内攻击力<span style='color:#0098DC;'>+{atk:0%}</span>",
        "部署后<span style='color:#0098DC;'>{duration}</span>秒内攻击力<span style='color:#0098DC;'>+{atk:0%}</span>",
        "部署后<span style='color:#0098DC;'>{duration}</span>秒内攻击力<span style='color:#0098DC;'>+{atk:0%}</span>",
        "部署后<span style='color:#0098DC;'>{duration}</span>秒内攻击力<span style='color:#0098DC;'>+{atk:0%}</span>",
        "部署后<span style='color:#0098DC;'>{duration}</span>秒内攻击力<span style='color:#0098DC;'>+{atk:0%}</span>",
    ...
    },
    {
      ...
      passive = false,
      description = {
        "攻击力、防御力和生命上限各<span style='color:#0098DC;'>+{atk:0%}</span>",
        "攻击力、防御力和生命上限各<span style='color:#0098DC;'>+{atk:0%}</span>",
        "攻击力、防御力和生命上限各<span style='color:#0098DC;'>+{atk:0%}</span>",
        "攻击力、防御力和生命上限各<span style='color:#0098DC;'>+{atk:0%}</span>",
        "攻击力、防御力和生命上限各<span style='color:#0098DC;'>+{atk:0%}</span>",
      ...
      levels = {
        {
          ...
          level = 1,
          potential = 0,
          description = "All 【Abyssal Hunters】 operatives gain Attack +7%",
        },
        {
          elite = 1,
          level = 1,
          potential = 4,
          description = "All 【Abyssal Hunters】 operatives gain Attack +9% (+2%)",
        },
        {
          elite = 2,
          level = 1,
          potential = 0,
          description = "All 【Abyssal Hunters】 operatives gain Attack +14%",
        },
        {
          elite = 2,
          level = 1,
          potential = 4,
          description = "All 【Abyssal Hunters】 operatives gain Attack +16% (+2%)",
        },
      }
    },
    {
      ...
      levels = {
        {
          ...
          level = 1,
          potential = 0,
          description = "Self redeploy time -10 seconds",
        },
      }
    },
  },
