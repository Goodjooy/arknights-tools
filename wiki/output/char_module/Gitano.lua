return {
  ...
  profile = {
    ...
    oripathy = {
      infected = "Yes",
      diagnosis = "造影检测结果显示，该干员体内脏器轮廓模糊，可见异常阴影，循环系统内源石颗粒检测异常，有矿石病感染迹象，现阶段可确认为是矿石病感染者。<br><br>【体细胞与源石融合率】5%<br>远山的神秘学能力可能与感染有关，但尚无确切证据。<br><br>【血液源石结晶密度】0.3 u/L<br>感染步入中期，源石开始影响身体机能但并不明显。",
    }
  },
  quotes = {
    cn001 = "嗯，博士。您今天的运势是......",
