  ...
  skills = {
    {
      ...
      passive = false,
      description = "抵挡下一次伤害，在<span style='color:#0098DC;'>8/8/8/8</span>秒内防御力<span style='color:#0098DC;'>+0.4/0.6/0.8/1</span>\n<span style='color:#F49800;'>技能自动开启</span>",
    ...
    },
    {
      ...
      passive = false,
      description = "攻击间隔<span style='color:#FF6237;'>增大</span>，攻击力<span style='color:#0098DC;'>+0.85/1.05/1.25/2</span>，每次攻击对最多<span style='color:#0098DC;'>3/3/3/4</span>个敌人造成<span style='color:#0098DC;'>法术伤害</span>，并有<span style='color:#0098DC;'>0.1/0.15/0.2/0.25</span>概率使命中目标晕眩<span style='color:#0098DC;'>1/1/1/1</span>秒\n<span style='color:#F49800;'>持续时间结束后雷蛇晕眩5/5/5/5秒</span>",
