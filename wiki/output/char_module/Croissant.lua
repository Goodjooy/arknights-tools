  ...
  skills = {
    {
      ...
      passive = false,
      description = "防御力<span style='color:#0098DC;'>+0.2/0.3/0.4/0.7</span>，天赋效果<span style='color:#0098DC;'>提升至1.1/1.4/1.7/2</span>\n<span style='color:#F49800;'>技能自动开启</span>",
    ...
    },
    {
      ...
      passive = false,
      description = "将周围敌人<span style='color:#0098DC;'>大力地</span>弹开并击晕<span style='color:#0098DC;'>2.5/3/3.5/4</span>秒，造成相当于攻击力<span style='color:#0098DC;'>2.4/3/3.6/4.8</span>的物理伤害",
