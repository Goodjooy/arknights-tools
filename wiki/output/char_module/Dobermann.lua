return {
  ...
  profile = {
    ...
    oripathy = {
      infected = "Yes",
      diagnosis = "造影检测结果显示，该干员体内脏器轮廓模糊，可见异常阴影，循环系统内源石颗粒检测异常，有矿石病感染迹象，现阶段可确认为是矿石病感染者。<br><br>【体细胞与源石融合率】14%<br>体表暂未出现明显的源石病病征。<br><br>【血液源石结晶密度】0.26u/L<br>感染进入前期，但暂时还没有带来明显身体影响。",
    }
  },
  quotes = {
