  ...
  skills = {
    {
      ...
      passive = false,
      description = "攻击力<span style='color:#0098DC;'>+0.45<span>/</span>0.58<span>/</span>0.67<span>/</span>0.8</span>，攻击速度<span style='color:#0098DC;'>+10<span>/</span>10<span>/</span>20<span>/</span>20</span>",
    ...
    },
    {
      ...
      passive = false,
      description = "下次治疗使目标获得一个持续<span style='color:#0098DC;'>2<span>/</span>2<span>/</span>3<span>/</span>3</span>秒的护盾\n护盾可以吸收相当于闪灵攻击力<span style='color:#0098DC;'>0.2<span>/</span>0.28<span>/</span>0.35<span>/</span>0.5</span>的伤害，同时使目标防御力<span style='color:#0098DC;'>+0.2<span>/</span>0.25<span>/</span>0.35<span>/</span>0.5</span>；<span style='color:#F49800;'>可充能1<span>/</span>1<span>/</span>2<span>/</span>3次</span>",
    ...
    },
    {
      ...
      trigger = "Manual Trigger",
      passive = false,
      description = "攻击力<span style='color:#0098DC;'>+0.2<span>/</span>0.3<span>/</span>0.4<span>/</span>0.5</span>\n攻击范围内的所有友方单位防御力<span style='color:#0098DC;'>+0.3<span>/</span>0.45<span>/</span>0.6<span>/</span>1</span>",
