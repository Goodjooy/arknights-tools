return {
  ...
  profile = {
    records = {
      ...
      archive4 = "很显然，缠丸小姐对于自己的弱点有明显的自觉：不擅控制力量；不擅思考。<br>为此，她选择用插花来锻炼技巧，用不去完全相信别人来保护自己。<br>——当然，即使如此，她也依然容易受骗，缠丸小姐就是这么单纯的一个人。但至少，她已经学会了去怀疑，为了生存，她必须让不擅长思考的自己学会这么做。<br>而正因为如此，对这样的她来说，如果有一个即使她什么都不用想，也绝对不会欺骗她、背叛她，还会陪伴她、引导她的人存在，那她......该会有多喜欢那个人呀。",
      token = "",
    },
    bio = {
      gender = "Female",
    ...
    oripathy = {
      infected = "No",
      diagnosis = "造影检测结果显示，该干员体内脏器轮廓清晰，未见异常阴影，循环系统内源石颗粒检测未见异常，无矿石病感染迹象，现阶段可确认为非矿石病感染者。<br><br>【体细胞与源石融合率】0%<br>干员缠丸没有被源石感染的迹象。<br><br>【血液源石结晶密度】0.12u/L<br>干员缠丸甚少接触源石。",
    }
  },
  quotes = {
