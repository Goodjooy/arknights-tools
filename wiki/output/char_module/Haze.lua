return {
  ...
  profile = {
    ...
    oripathy = {
      infected = "Yes",
      diagnosis = "造影检测结果显示，该干员体内脏器轮廓模糊，可见异常阴影，循环系统内源石颗粒检测异常，有矿石病感染迹象，现阶段可确认为是矿石病感染者。<br><br>【体细胞与源石融合率】16%<br>体表没有出现明显源石结晶，但体内污染较为严重。<br><br>【血液源石结晶密度】0.36u/L<br>感染步入中期，源石结晶开始增幅宿主的源石技艺。",
    }
  },
  quotes = {
